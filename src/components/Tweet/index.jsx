            ...
            <div className="flex space-x-3">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex justify-between mt-4 text-gray-500">
                        ...
                        <div className="flex items-center cursor-pointer hover:text-green-400 transition duration-200">
                            <FontAwesomeIcon icon={faRetweet} onClick={() => handleAction('retweet')}/>
                            <span className="ml-2">{retweet}</span>
                        </div>
                        <div className="flex items-center cursor-pointer hover:text-red-400 transition duration-200">
